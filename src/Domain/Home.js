  ...
  return (
    <>
      ...
      <section className='section-start'>
            ...
            <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active pb-5">
                  <div className='row m-0'>
                    <div className='col-lg-3 col-md-6 col-sm-12 col-12 py-2 d-flex align-items-stretch'>
                      <div className="card card-image1 card-border align-self-stretch" >
                        <div className="card-body card-content">
                          <h5 className="card-title">Joaquín Díaz</h5>
                          <h6 className="card-title">Age - 27</h6>
                          <h6 className="card-title">B.Tech</h6>
                          <h6 className="card-title">Coimbatore</h6>
                        </div>
                      </div>
                    </div>
                    <div className='col-lg-3 col-md-6 col-sm-12 col-12 d py-2 d-flex align-items-stretch'>
                      <div className="card card-image2 card-border align-self-stretch" >
                        <div className="card-body card-content">
                          <h5 className="card-title">MohammedHassan</h5>
                          <h6 className="card-title">Age - 27</h6>
                          <h6 className="card-title">B.Tech</h6>
                          <h6 className="card-title">Coimbatore</h6>
                        </div>
                    ...
                    <div className='col-lg-3 col-md-6 col-sm-12 col-12 d py-2 d-flex align-items-stretch'>
                      <div className="card card-image3 card-border align-self-stretch" >
                        <div className="card-body card-content">
                          <h5 className="card-title">Đường Vy </h5>
                          <h6 className="card-title">Age - 27</h6>
                          <h6 className="card-title">B.Tech</h6>
                          <h6 className="card-title">Coimbatore</h6>
                        </div>
        ...
        <div className='video-call container-85 mb-5'>
          <div className='row m-0'>
